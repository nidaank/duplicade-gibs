...
@section('content')
    <div class="container d-flex flex-wrap justify-content-center" style="margin-top: 111px">
        @forelse ($berita as $item)
            <div class="card col-11 col-md-8 col-lg-5 mx-4 mb-4 border-primary">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <p class="card-text mb-3"><span class="fw-semibold">Tanggal Upload :</span> {{ $item->tanggal_upload }}</p>
        ...
        @empty
            <div class="d-flex flex-column justify-content-center align-items-center py-5" style="height: 350px">
